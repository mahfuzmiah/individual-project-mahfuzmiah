...
for col in data.columns:
    ...
    if pd.api.types.is_numeric_dtype(data[col]):
        ...
        if len(unique_values) < 252:  # Adjust threshold if needed
            unique_values_summary[col] = unique_values[:252]
        else:
...
output_file = "/Users/mahfuz/Final_project/Final_repo/DataSets/LBSUniqueColumnSummary.csv"
