...
def main():
    ...
    plt.legend()
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Seasonal_Naive_Forecast_Diagrams/SeasonalNaiveForecast_AT_AL_Q.png')
    plt.show()
    ...
    plt.grid(True)
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Seasonal_Naive_Forecast_Diagrams/WMAPE_over_time.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Seasonal_Naive_Forecast_Diagrams/SeasonalNaiveForecast_US_ZW_U.png')
    plt.show()
