...
def main():
    ...
    overall_wmape = wmape(results['y'], results['SeasonalNaive'])
    ...
    plt.legend()
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Diagrams/Seasonal_Naive_Forecast_Diagrams/SeasonalNaiveForecast_AT_AL_Q.png')
    plt.show()

    # Plot WMAPE over time
    wmape_by_date = results.groupby('ds')[['y', 'SeasonalNaive']].apply(
        lambda x: wmape(x['y'], x['SeasonalNaive'])
    )
    plt.figure(figsize=(10, 5))
    ...
    plt.grid(True)
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Diagrams/Seasonal_Naive_Forecast_Diagrams/WMAPE_over_time.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig(
        '/Users/mahfuz/Final_project/Final_repo/Diagrams/Seasonal_Naive_Forecast_Diagrams/SeasonalNaiveForecast_US_ZW_U.png')
    plt.show()
